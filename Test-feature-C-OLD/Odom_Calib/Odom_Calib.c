...
Coordinate_Class_t Odom_Calib (float velocity_x, float angular_velocity_angle)
{
	...
	Odom_Coor.angle_coor = PGV150_coor.angle_coor + angle;    //里程推算角度运算
	//Coor_delta.x_coor += delta_distance *  (Odom_Coor.angle_coor);
	...
	//printf("Coor_delta.x_coor = %f, Coor_delta.y_coor = %f, Coor_delta.angle_coor = %f\n", Coor_delta.x_coor, Coor_delta.y_coor, Coor_delta.angle_coor);
