...
if( fabs( direction_x ) > 7 || fabs( direction_y ) > 7)
{
	if ( (Add_Command_Line == 1) ||  (Add_Command_Rotate == 1))
	{
		...
		if (judge_axis == 1)  //X方向
		{
			if (abs(PGV150_coor.angle_coor) < 8.0)
			goStraight();
		...
		{
			printf("angle_deviation=%f\n",angle_deviation);
			if (abs(angle_deviation-270) < 8.0)
			goStraight();
...
/********************************************左转******************************************************/
            else if (Motionstyle == ACTION_MODE_TRUNLEFT)
            {
                ...
                if ((Error_Coor_InAGV.angle_coor <= 8.0) && (Error_Coor_InAGV.angle_coor > -8.0))
                {
                    VL_1200 = 0.0;
                    VR_1200 = 0.0;
                }
...
/********************************************右转******************************************************/
            else if (Motionstyle == ACTION_MODE_TRUNRIGHT)
            {
                ...
                if ((Error_Coor_InAGV.angle_coor <= 8.0) && (Error_Coor_InAGV.angle_coor > -5.0))
                {
                    VL_1200 = 0.0;
                    VR_1200 = 0.0;
                }
